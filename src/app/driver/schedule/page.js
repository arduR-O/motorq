...
const ScheduleContent = () => {
    ...
    if (!driver) {
        return (
            <main className="min-h-screen min-w-screen flex flex-col justify-start items-center gap-5 py-5 relative">
                <Header content="Driver Schedule" />
                <div className="mx-auto uppercase text-[16px] md:text-[12px] md:mx-[10%] text-[#B7AB98] mb-2 tracking-[7px]">
